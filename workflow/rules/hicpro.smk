...
rule hicpro_align_only_with_parallel: # localrule
    ...
    shell:
        """
            ...
            /home/jreyna/software/HiC-Pro-Full/HiC-Pro-3.0.0/bin/HiC-Pro -s mapping \
                    -p \
                    -i $abs_datadir \
                    -o $abs_outdir \
                    -c {input.config} >> {log} 2>&1
            ...
            # cd into the location for the HiCPro_step1.h script, required for proper
            # pathing within the qsub script.
            #cd {params.outdir} >> {log} 2>&1

            # running the qsub script generated by HiC-Pro
            #echo "# running the qsub script generated by HiC-Pro" >> {log} 2>&1
            #qids=$(qsub HiCPro_step1_.sh) >> {log} 2>&1
...
#        hicpro_img = rules.download_hicpro_singularity_img.output.hicpro_img
#    output:
#        mats = directory('results/main/{cline}/hicpro_with_parallel/hic_results/matrix/{cline}/raw/'),
#        mats_complete = touch('results/main/{cline}/hicpro_with_parallel/hic_results/matrix/{cline}/raw/mats.complete')
#    params:
#        datadir = 'results/main/{cline}/hicpro_with_parallel/hic_results/data/',
#        outdir = 'results/main/{cline}/hicpro_with_parallel/'
#    resources:
...
#        mem_mb = 64000
#    log:
#        'results/main/{cline}/logs/rule_hicpro_build_contact_maps_only_with_parallel_{cline}.log'
#    benchmark:
#        'results/main/{cline}/benchmarks/rule_hicpro_build_contact_maps_only_with_parallel_{cline}.bmk'
#    shell:
#        """
#            # getting absoluate paths for data and outdirs, required
#            # by HiCPro
...
## matrix = 'results/main/{cline}/hicpro/hic_results/matrix/{cline}/iced/10000/{cline}_10000_iced.matrix',
## biases = 'results/main/{cline}/hicpro/hic_results/matrix/{cline}/iced/10000/{cline}_10000_iced.matrix.biases'
#rule hicpro_ice_norm_only_with_parallel: #  merging update complete
#    input:
#        mats_complete = rules.hicpro_build_contact_maps_only.output.mats_complete,
#        config = ancient(re_config_file),
#        hicpro_img = rules.download_hicpro_singularity_img.output.hicpro_img
#    output:
#        iced = directory('results/main/{cline}/hicpro_with_parallel/hic_results/matrix/{cline}/iced/'),
#        iced_complete = touch('results/main/{cline}/hicpro_with_parallel/hic_results/matrix/{cline}/iced/iced.complete')
#    params:
#        datadir = 'results/main/{cline}/hicpro_with_parallel/hic_results/matrix/',
#        outdir = 'results/main/{cline}/hicpro_with_parallel/'
#    resources:
#        nodes = 1,
#        ppn = 4,
#        mem_mb = 64000
#    log:
#        'results/main/{cline}/logs/rule_hicpro_ice_norm_with_parallel_{cline}.log'
#    benchmark:
#        'results/main/{cline}/benchmarks/rule_hicpro_ice_norm_with_parallel_{cline}.bmk'
#    shell:
#        """
#            # getting absoluate paths for data and outdirs, required
#            # by HiCPro
