...
rule hicpro_align_only_with_parallel: # localrule
    ...
    params:
        datadir = 'results/main/{cline}/hicpro_with_parallel/renamed_fastqs/', # part of rule rename_before_hicpr
        outdir = 'results/main/{cline}/hicpro_with_parallel/',
        qscript = 'results/main/{cline}/hicpro_with_parallel/HiCPro_step1_.sh'
    log:
